  ...
  return (
    <Resizable
      className={`flex flex-col rounded-t-2xl overflow-hidden ${
        theme === "dark" ? "bg-[#142028]" : "bg-gray-100"
      } mx-2`}
    ...
    >
        ...
        <div className="flex items-center">
          ...
          >
            <h3 className={`font-semibold text-lg flex items-center`}>
              {coinData.name}
              <span className="ml-1">({coinData.symbol.toUpperCase()})</span>
            </h3>
          </div>
        </div>
          ...
          <div className="flex items-center">
            <span
              className={`ml-1 text-sm font-bold ${
                coinData.market_data.price_change_percentage_24h >= 1
                  ? "text-green-500"
                  : "text-red-500"
              }`}
            >
      ...
      <div className={"text-center w-80 mx-auto md:hidden"}>
      ...
      <div className="flex-grow">
        <iframe
          ...
          width="100%"
          height="100%"
          src="https://www.dextools.io/widget-chart/en/ether/pe-light/0x619a6b75b0b56e6638a194c84a26ebeaf4a55381?theme=dark&chartType=1&chartResolution=1&drawingToolbars=true"
        ></iframe>
